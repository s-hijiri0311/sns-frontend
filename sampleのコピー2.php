...
if(isset($_POST["login"])) {
  $id = $_POST["username"];
  $pass = $_POST["password"];
  $url = "http://ec2-3-115-14-119.ap-northeast-1.compute.amazonaws.com/login_api.php?name={$id}&pass={$pass}";
  $url2 = "http://ec2-3-115-14-119.ap-northeast-1.compute.amazonaws.com/talk_api.php?name={$id}&pass={$pass}";
